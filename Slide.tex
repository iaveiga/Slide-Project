...
\begin{document}
	...
	\begin{frame}
		\frametitle{NotifyMe}
			...
			%\textbf{\emph{NotifyMe}} nace de la necesidad de la falta de una aplicaciÃ³n para smartphones que recuerde una 	                                %lista de tareas dado lugares geogr
	...
	\begin{frame}
		\frametitle{NotifyMe}
		\begin{block}{\textbf{Especificaciones TÃ©cnicas}}
			\begin{itemize}
